...
import { getGroupList } from "../../api/helpers";
import { CreateGroupMemberInterface, GroupsInterface, UserBasicInterface } from "../../models";
    ...
    return (
        ...
        >
            <Modal.Header className="wizard-header">
                ...
                <Heading as="h6">
                    {
                        t("Create a new role in the system.", { type: "role" })
                    }
                </Heading>
            </Modal.Header>
